...
SCENARIO_GLOB="${SCENARIO_GLOB:-*easy*.yaml}"
BASE_PATH="${BASE_PATH:-configs/sim/nuscenes_base_local_0428_rap.yaml}"
...
declare -a PLANNER_PATHS=(
    "configs/planners/rap.yaml"
    "configs/planners/rap_vlm_0428.yaml"
    "configs/planners/rap_vlm_default_trajectory_0428.yaml"
    "configs/planners/rap_vlm_intervention_1cam_0428.yaml"
    "configs/planners/rap_vlm_intervention_4cam_0428.yaml"
    "configs/planners/rap_vlm_default_trajectory_intervention_1cam_0428.yaml"
    "configs/planners/rap_vlm_default_trajectory_intervention_4cam_0428.yaml"
)

declare -a JOB_LABELS=(
    "rap"
    "rap_vlm"
    "rap_vlm_default_trajectory"
    "rap_intervention_vlm_1_cam"
    "rap_intervention_vlm_4_cam"
    "rap_intervention_vlm_default_trajectories_1_cam"
    "rap_intervention_vlm_default_trajectories_4_cam"
)
...
for idx in "${!PLANNER_NAMES[@]}"; do
    ...
    echo "preparing planner=${job_label} planner_name=${planner_name} gpus_per_job=${gpus} max_jobs=${max_jobs}"
