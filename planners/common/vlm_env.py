...
VLM_ENV_DEFAULTS: Dict[str, Any] = {
    ...
    "PLANNER_GATE_CAMERA_MODE": "",
    "PLANNER_GATE_MAX_NEW_TOKENS": 120,
    "PLANNER_GATE_TIMEOUT_SEC": 10.0,
    "PLANNER_GATE_DEFAULT_PLANNER": "learned",
    "PLANNER_GATE_SAVE_DEBUG_ARTIFACTS": True,
...
VLM_ENV_FIELD_NAMES: Dict[str, str] = {
    ...
    "PLANNER_GATE_CAMERA_MODE": "planner_gate_camera_mode",
    "PLANNER_GATE_MAX_NEW_TOKENS": "planner_gate_max_new_tokens",
    "PLANNER_GATE_TIMEOUT_SEC": "planner_gate_timeout_sec",
    "PLANNER_GATE_DEFAULT_PLANNER": "planner_gate_default_planner",
    "PLANNER_GATE_SAVE_DEBUG_ARTIFACTS": "planner_gate_save_debug_artifacts",
